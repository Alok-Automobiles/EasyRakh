...
export function VideoText({
  ...
  const ComponentWithProps = Component as React.ElementType<React.HTMLAttributes<HTMLElement> & { children?: ReactNode }>
  
  return (
    <ComponentWithProps className={cn(`relative size-full`, className)}>
