    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-24">
          <h2 className="text-base font-semibold text-emerald-600 tracking-wide uppercase mb-2">Powerful Features</h2>
        ...
        <div className="space-y-12">
          ...
          <FeatureBlock 
            icon={Users}
            title="Manage Suppliers & Customers Separately"
        ...
        <div className="mt-24 text-center">
          <Button asChild size="lg" className="text-lg px-10 py-7 bg-gray-900 hover:bg-gray-800 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 cursor-none">
            <Link href="/register">
              Start Managing Now
